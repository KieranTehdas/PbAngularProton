...
//
#ifndef SCOREPARAMETERISATION_HH
#define SCOREPARAMETERISATION_HH
...
class ScoreParameterisation : public G4VPVParameterisation {

public:
  
  // Constructor
  ScoreParameterisation(const G4double minRadius, const G4double maxRadius, 
				const G4double deltaTheta);
  
  // Destructor
  virtual ~ScoreParameterisation();
