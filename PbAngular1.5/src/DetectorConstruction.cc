...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
	...
	G4VSolid* scoreSolid = new G4Sphere("ScoreSolid",
	 ...
	 scoringLog = new G4LogicalVolume(scoreSolid, NaI, "ScoringLogical");
...
void DetectorConstruction::ConstructSDandField()
{
	...
	//sensitive detector
	G4String sensitiveDetectorName = "Sensitive Ring";
	
	TrackerSD* aTrackerSD = new TrackerSD(sensitiveDetectorName, "TrackerHitsCollection");
	SetSensitiveDetector(scoringLog, aTrackerSD);
}
